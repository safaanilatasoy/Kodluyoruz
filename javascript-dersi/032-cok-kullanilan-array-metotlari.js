...
// Array içerisindeki oğenin index bilgisini bulmak -> indexOf(item)
items.unshift("lorem")
items.push("ipsum")
...
let es6Items = [...items] // ES6 ile kopyalama - es6 ve sonrasında gelen kopyalama işlemi
...
// iki Array bilgisini birleştirmek -> concat
let allUsers = [...femaleUsers, ...maleUsers]; // es6 ile iki arrayi birleştirme
console.log(allUsers);


// istediğimiz index bilgisine oge eklemek -> splice(pos, 0, item)
